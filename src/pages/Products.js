...
export const Products = () => {
  ...
  return (
    <>
      ...
      <div class="catscroll text-white  overflow-scroll flex-nowrap md:space-x-4 sm:space-x-4 hidden sm:flex pt-4 my-8 mx-8 ">
        {catt.map((d, i) =>
          ...
          return (
            <>
              <div class="relative  flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md" key={index}>
                <a class="relative flex h-52 overflow-hidden justify-center" href={`/products/${item.id}`}>
                ...
                <div class="mt-4 px-5 pb-2">
                  ...
                  <button onClick={() => { dispatch({ type: "ADD", payload: item }); }} class="flex w-full items-center justify-center rounded-md bg-indigo-800 px-5 py-2 text-center text-sm font-medium text-white hover:bg-white hover:text-indigo-800 border-2	 border-indigo-700 focus:outline-none focus:ring-4 focus:ring-blue-300 shadow-lg shadow-indigo-500/50">
