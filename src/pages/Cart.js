...
const Cart = () => {
 ...
 text-7xl capitalize font-bold tracking-tight'>add products to cart</h2>
      {state.map((item, index) => {
        return (
          <>
            <div className="mt-5 max-w-sm w-full lg:max-w-full lg:flex justify-center" key={index}>
              ...
              <div className=" text-white border-white border border-l-0 h-48 grid justify-center items-center lg:h-auto lg:w-48 bg-black rounded-b lg:rounded-b-none lg:rounded-r" >
